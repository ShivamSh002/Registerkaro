...
const slides = [
  {
    name: "Alice Johnson",
    platform: "LinkedIn",
    icon: <LinkedInIcon className="text-blue-600 mr-3 !text-5xl" />,
    description:
  ...
  },
  {
    name: "Rahul Sharma",
    platform: "Google",
    icon: <GoogleIcon className="text-red-500 mr-3 !text-5xl" />,
    description:
  ...
  },
  {
    name: "Neha Verma",
    platform: "Twitter",
    icon: <TwitterIcon className="text-blue-400 mr-3 !text-5xl" />,
    description:
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center mb-5">
          ...
          <p className="mt-2 max-w-3xl mx-auto text-gray-600 leading-relaxed">
            We are one of India's highest rated service provider, we are known for completing Business incorporations and other compliance services in record time, don't have to believe us, read it by yourselves
          </p>
